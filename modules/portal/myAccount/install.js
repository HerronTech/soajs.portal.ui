...
var myAccountNav = [
	{
		...
		'url': '#/login',
		'guestMenu': true,
		'tplPath': 'modules/portal/myAccount/directives/login.tmpl',
		'scripts': ['modules/portal/myAccount/config.js', 'modules/portal/myAccount/controller.js']
	},
	{
		'id': 'register',
		'label': 'Register',
		'url': '#/register',
		'tplPath': 'modules/portal/myAccount/directives/register.tmpl',
		'scripts': ['modules/portal/myAccount/config.js', 'modules/portal/myAccount/controller.js'],
		'guestMenu': true
	},
	{
		...
		'url': '#/forgotPw',
		'tplPath': 'modules/portal/myAccount/directives/forgotPassword.tmpl',
		'scripts': ['modules/portal/myAccount/config.js', 'modules/portal/myAccount/controller.js'],
		'guestMenu': false
	},
	{
		...
		'url': '#/resetPassword',
		'scripts': ['modules/portal/myAccount/config.js', 'modules/portal/myAccount/controller.js'],
		'tplPath': 'modules/portal/myAccount/directives/resetPassword.tmpl',
		'guestMenu': false
	},
	{
		'id': 'set_password',
		//'label': 'Set Password',
		'url': '#/setNewPassword',
		'tplPath': 'modules/portal/myAccount/directives/setNewPassword.tmpl',
		'scripts': ['modules/portal/myAccount/config.js', 'modules/portal/myAccount/controller.js'],
		'guestMenu': false
	},
	{
		...
		'tplPath': 'modules/portal/myAccount/directives/validate.tmpl',
		'scripts': ['modules/portal/myAccount/config.js', 'modules/portal/myAccount/controller.js'],
		'guestMenu': false
	},
	{
	...
	},
	{
		...
		'url': '#/myaccount',
		'icon': 'smile',
		'tplPath': 'modules/portal/myAccount/directives/myAccount.tmpl',
		'scripts': ['modules/portal/myAccount/config.js', 'modules/portal/myAccount/controller.js'],
		'userMenu': true,
		'private': true
	}
