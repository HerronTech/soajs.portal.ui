...
contentManagementApp.controller("ContentManagementModuleStgCtrl", ['$scope', 'ngDataApi', '$compile', '$timeout', '$modal', 'injectFiles', 'cmModuleStgService', function ($scope, ngDataApi, $compile, $timeout, $modal, injectFiles, cmModuleStgService) {
	...
	$scope.listCMDataEntries = function () {
		var grid = angular.copy(cmModuleStgConfig.grid);
	...
	$scope.addCMDataEntry = function () {
		var config = cmModuleStgConfig.form.add;
	...
	$scope.editCMDataEntry = function (data) {
		...
		var config = cmModuleStgConfig.form.update;
	...
	injectFiles.injectCss(cmModuleStg + "/contentManagement.css");
}]);